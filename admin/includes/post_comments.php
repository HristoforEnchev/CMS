<div class="table-responsive">
    <table class="table table-bordered table-hover">
        ...
        <?php
            ...
            if (isset($_GET['post_id'])) {
                ...
                $query_comments_all = "SELECT * FROM comments WHERE comment_post_id = {$post_id}";
                ...
                while($row = mysqli_fetch_assoc($select_comments_all)){
                    ...
                    echo "<td><a href='comments.php?source=comments&del={$comment_id}&post_id={$post_id}'>Delete</a></td></tr>";
                }
    ...
    <?php
        ...
        if(isset($_GET['del'])){
            ...
            header("Location: comments.php?source=comments&post_id={$_GET['post_id']}");  //reload   refresh
